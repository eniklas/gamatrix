...
```bat
PowerShell.exe -command Invoke-WebRequest -Method Post -Uri "http://<your-gamatrix-url>/compare?option=upload" -InFile "C:\ProgramData\GOG.com\Galaxy\storage\galaxy-2.0.db"
pause
```
